                    ...
                    <div class="datatable table-responsive">
                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?= $get_student->getStudent($enrollment['student_id'])['first_name'] . ' ' . $get_student->getStudent($enrollment['student_id'])['last_name']; ?>
                                    </td>
                                    <td>
                                        <?= $get_student->getStudent($enrollment['student_id'])['address']; ?>
                                    </td>
                                    <td>
                                        <?= $get_user->getUser($enrollment['student_id'])['user_email']; ?>
                                    </td>
                                    <td>
                                        <a href="student.php?id=<?= $enrollment['student_id']; ?>"
