...
if(isset($_SESSION['coordinator_id']) || $_SESSION['coordinator_id'] == true) {
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="user_email" type="user_email" name="user_email" aria-describedby="emailHelp" placeholder="Enter email address" />
                                </div>
                                <div class="form-group"><label class="small mb-1" for="user_password">Password</label>
                                    <input class="form-control py-4" id="user_password" type="user_password"
