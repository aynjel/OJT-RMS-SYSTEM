                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="course_id" name="course_id"
                                            value="<?php (isset($get_course->getCourse($student['course_id'])['course_name'])) ? print($get_course->getCourse($student['course_id'])['course_name']) : print('No Course'); ?>"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email"
                                            value="<?= $get_user->getUser($student['student_id'])['user_email']; ?>"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="status" name="status"
                                            value="<?= $get_user->getUser($student['student_id'])['user_status']; ?>"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="course_id" name="course_id" required>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php foreach ($get_course->getCourses() as $course) : ?>
