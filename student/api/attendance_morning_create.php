...
class Attendance extends Database{
    ...
    public function AttendanceTimeOut($attendance_id, $attendance_time_out){
        ...
        $stmt = $this->connection->prepare($sql);
        $result = $stmt->execute([$attendance_time_out, $attendance_id, 'Morning']);
        return $result;
    }
...
if($check['attendance_log'] == 'Morning'){
    $result = $attendance->AttendanceTimeOut($check['attendance_id'], $attendance_time);
    if($result){
        echo 'success morning out';
    }else{
        echo 'error morning out';
    }
}else{
    ...
    if($result){
        echo 'success morning in';
    }else{
        echo 'error morning in';
    }
}